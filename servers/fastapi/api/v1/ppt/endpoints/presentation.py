        ...
        for i, slide_layout_index in enumerate(structure.slides):
            ...
            try:
                slide_content = await get_slide_content_from_type_and_outline(
                    ...
                    slide_number=i + 1,
                    usage_tracker=usage_tracker,  # Record slide generation tokens for TubeOnAI credit deduction
                )
    ...
    try:
        ...
        if not using_slides_markdown:
            ...
            async for chunk in generate_ppt_outline(
                ...
                usage_tracker=usage_tracker,  # Record outline generation tokens for TubeOnAI credit deduction
            ):
        ...
        # 9. Convert usage tracker to metadata, then export
        usage_metadata = usage_tracker.to_metadata()
