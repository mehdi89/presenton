...
# Azure OpenAI image deployment name (used by the Azure DALL-E image provider;
# distinct from the generic get_azure_openai_deployment_env() defined above
# alongside the other canonical Azure OpenAI env readers used for the LLM).
