      ...
      <div className="py-[18px] px-4 sticky top-0 bg-white z-50 shadow-sm font-syne flex justify-between items-center gap-4">
        <div className="flex items-center gap-3">
          <ToolTip content="Back">
            <img
              onClick={() => {
                // TubeOnAI iframe integration: redirect to the parent app's
                // origin instead of presenton's own /dashboard (which is
                // unreachable on the restricted embed domain anyway).
                let redirectUrl = "https://web.tubeonai.com";
                if (returnUrl) {
                  try {
                    redirectUrl = new URL(returnUrl).origin;
                  } catch {
